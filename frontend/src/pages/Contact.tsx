export const Contact = () => {
  return (
    <section className="min-h-screen bg-gradient-to-r from-blue-600 via-blue-800 to-blue-900 dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 mb-4">
      <div className="container flex flex-col min-h-screen px-6 py-6 mx-auto">
            ...
            <div className="mt-6 space-y-8 md:mt-8">
              <p className="flex items-start -mx-2">
                ...
                <span className="mx-2 text-white truncate w-72">
                  New Land, New Delhi, India, 110022
                </span>
              </p>
