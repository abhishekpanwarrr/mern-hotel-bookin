        ...
        <div className="basis-1/2">
          <div className="w-full h-96">
            <img
              ...
              src="https://images.pexels.com/photos/1499477/pexels-photo-1499477.jpeg?auto=compress&cs=tinysrgb&w=800"
          ...
          <div className="flex justify-between gap-1 items-center my-4">
            ...
            <div>
              <p className="font-semibold text-base ">
                ₹ 1500 <span className="text-sm font-normal">/night</span>
              </p>
            </div>
          </div>
          {/* Hotel Description */}
          <div className="mb-2">
            <p className="text-sm text-gray-500 font-extralight pl-2">
              ...
              quas voluptas pariatur, sed doloribus quod voluptatum nemo
              assumenda dolore in.
            </p>
          </div>
          {/* Extra Info */}
